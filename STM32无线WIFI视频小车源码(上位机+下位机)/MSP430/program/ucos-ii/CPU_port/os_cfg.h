...
#define OS_LOWEST_PRIO           63//8    /* Defines the lowest priority that can be assigned ...         */
...
#define OS_SCHED_LOCK_EN          1//0    /*     Include code for OSSchedLock() and OSSchedUnlock()       */
...
#define OS_TICKS_PER_SEC        125//200    /* Set the number of ticks in one second                        */
...
#define OS_FLAG_NAME_SIZE         1    /*     Determine the size of the name of an event flag group    */
